        ...
        <div className="card hero-interaction ">
          <div className="card-body text-center ">
            ...
            <li className="list-group-item hero-interaction"> <p className="card-text"> <span className="fw-bold">Sold By</span> :  {product.vendor_name}</p></li>
               <li className="list-group-item hero-interaction"><p className="card-text"> <span className="fw-bold">Price</span> : ${product.price}</p></li>
              <li className="list-group-item hero-interaction"> <p className="card-text"> <span className="fw-bold">Unit</span> : {product.unit} </p></li>
              <li className="list-group-item hero-interaction"> <p className="card-text"> <span className="fw-bold">Rating</span> :<ShowStars rating={Math.round(product.rating_sum / product.rating_count)} /> </p></li>
